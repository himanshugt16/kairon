...
class TestAccountProcessor:
    ...
    def test_delete_account_for_shared_bot(self):
        ...
        # Add shared bot
        bot_response = AccountProcessor.add_bot("delete_account_shared_bot", user_detail['account'],
                                                "udit.pandey@digite.com", False)
    ...
    def test_generate_integration_token_name_exists(self, monkeypatch):
        ...
        def _mock_get_bot_settings(*args, **kwargs):
            return BotSettings(bot=bot, user=user, integrations_per_user_limit=3)
